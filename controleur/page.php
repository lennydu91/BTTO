...
if(isset($_GET['page']))
{
	...
	{ 		
		...
		case 'news':
            echo '<link rel="stylesheet" href="theme/' .$_Serveur_['General']['theme']. '/css/style-news.css"/>';
			include('theme/' .$_Serveur_['General']['theme']. '/pages/news.php');
		break;
		...
		case 'map':
			include('theme/' .$_Serveur_['General']['theme']. '/pages/map.php');
		break;
