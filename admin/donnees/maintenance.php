<?php
$req = $bddConnection->query('SELECT maintenanceId, maintenanceMsg, maintenanceEtat, maintenanceMsgAdmin, maintenancePref FROM cmw_maintenance WHERE maintenanceId');
