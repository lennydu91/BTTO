...
<div class="row">
	...
	<center>Vous pourrez définir vos messages personnalisé ci-dessous :</center>
</br>
<table class="table table-striped table-bordered">
	...
	<form class="form-horizontal default-form" method="post" action="?&action=editMessage&maintenanceId=<?php echo $maintenance[$i]['maintenanceId']; ?>">
		...
		<tr>
			<td><input type="text" name="maintenanceMsg" value="<?php echo $maintenance[$i]['maintenanceMsg']; ?>" class="form-control" placeholder="Ex : Maintenance en cours.." required></td>
	...
	<tr>
		<form class="form-horizontal default-form" method="post" action="?&action=editMessageAdmin&maintenanceId=<?php echo $maintenance[$i]['maintenanceId']; ?>">
			<td><input type="text" name="maintenanceMsgAdmin" value="<?php echo $maintenance[$i]['maintenanceMsgAdmin']; ?>" class="form-control" placeholder="Ex : Vous êtes administrateur? Alors connectez-vous :" required></td>
			<td><input type="submit" class="btn btn-warning" value="Modifier le message !" /></td>
		</form>
