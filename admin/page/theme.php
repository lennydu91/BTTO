<h1><center><strong>Réglages généraux de votre thème</center></strong></h1>

<h3>Choisissez votre thème.</h3>


<div class="alert alert-dismissable alert-success"><center>Si vous souhaitez modifier un thème, modifiez une copie de l'original en créant un nouveau thème. Cela vous évitera de perdre votre thème lors d'une mise à jours !</center></a></div>
...
<div class="alert alert-dismissable alert-success"><center>Si vous voulez mettre une image, l'image doit être en 1920*1080 minimum pour s'adapater aux ecran et pour avoir une qualité optimal ! Vous pouvez aussi mettre une petite image qui se répettera !</center></a></div>
...
<div class="alert alert-dismissable alert-success"><center>Choisissez si vous préférez utiliser une grande image en fond de site ou une répétition de petits images ! </center></a></div>

<form class="form-horizontal default-form" method="post" action="?action=typeBG">
    <div class="radio">
