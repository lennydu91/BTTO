<h1><center><strong>Réglages du/des serveur(s) JSONAPI</center></strong></h1>

<h3><center>Ajouter un serveur</center></h3>
<div class="alert alert-dismissable alert-success"><center>Vous pouvez ajouter autant de serveurs minecraft que vous le souhaitez. La connection au(x) serveurs est essentiel !</center></a></div>
...
<form class="form-horizontal default-form" method="post" action="?&action=serveurJsonNew">
	...
	<div class="form-group">
		<div class="col-sm-offset-8 col-sm-2">
			<button type="submit" class="btn btn-warning">Ajouter mon serveur JSONAPI</button>
		</div>
	</div>
</form>
...
{ ?>
<div class="alert alert-danger"><center>Merci de bien vouloir ajouter un serveur pour pouvoir le modifier !!!</center></div>
<?php } else { ?>
<div class="alert alert-dismissable alert-success"><center>Vous pouvez modifier les données de vos serveurs ajoutés. Pour cela rien de plus simple, il vous suffit de remplir le formulaire ci-contre.</center></a></div>
