...
<div class="alert alert-dismissable alert-success"><center>L'accueil de votre site, la vitrine de votre serveur, ne négligez jamais cette page, ajoutez de belles images de slider ou encore des liens de navigations rapides le plus ergonomiques possibles !</center></a></div>
<hr>
...
<form method="post" action="?&action=changeSlider">
	...
	<input type="submit" class="btn btn-warning" value="Modifier le slider"/>
</form>
<hr>
