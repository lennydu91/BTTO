<h1><center>Configuration de la boutique</center></h1>
...
<form action="?&action=creerCategorie" method="post">
	...
	<div class="form-group col-md-12">
	    <button class="btn btn-warning col-md-offset-9 col-md-3" type="submit">Créer la catégorie !</button>
	</div>
</form>
<hr>
...
<form action="?&action=creerOffre" method="post">
	...
	<div class="form-group col-md-12">
	    <button class="btn btn-warning col-md-offset-9 col-md-3" type="submit">Créer l'offre !</button>
	</div>
</form>
<hr>
...
?>
	...
	<form method="post" action="?&action=boutique">
		...
		<h3>Categories <a href="?action=supprCategorie&id=<?php echo $categories[$i]['id']; ?>" class="btn btn-danger pull-right">supprimer la catégorie</a></h3>
		...
		<button class="btn btn-warning btn-block" type="submit">Valider mes changements</button>
	</form>
